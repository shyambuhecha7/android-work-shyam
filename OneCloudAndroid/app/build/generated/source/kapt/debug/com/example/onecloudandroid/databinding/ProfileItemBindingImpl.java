...
public class ProfileItemBindingImpl extends ProfileItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imgRight, 3);
        sViewsWithIds.put(R.id.imgArr, 4);
    }
    // views
    @NonNull
    ...
    private ProfileItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.tvDiscription.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvDiscription, description);
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
