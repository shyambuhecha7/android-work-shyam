...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.profile_toolbar, 10);
        sViewsWithIds.put(R.id.view, 11);
        sViewsWithIds.put(R.id.scrollview, 12);
        sViewsWithIds.put(R.id.profileImg, 13);
        sViewsWithIds.put(R.id.profileName, 14);
        sViewsWithIds.put(R.id.tvEmail, 15);
        sViewsWithIds.put(R.id.container1, 16);
        sViewsWithIds.put(R.id.container2, 17);
        sViewsWithIds.put(R.id.container3, 18);
    }
    // views
    @NonNull
